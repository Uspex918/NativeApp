    ...
    const handleGoogleSignIn = async () => {
        try {
            if (Platform.OS === "web") {
                ...
                // Use the callback registered by @clerk/expo in AndroidManifest.
                // This avoids Expo's nativeapp scheme being selected by
                // AuthSession in a standalone Android build.
